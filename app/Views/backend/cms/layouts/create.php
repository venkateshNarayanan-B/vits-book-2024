    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('cms/layouts/store/' . $theme['id']) ?>" method="post">
                        <?= csrf_field() ?>
                        <div class="form-group">
                            <label for="layout_name">Layout Name</label>
                            <input type="text" name="layout_name" id="layout_name" class="form-control <?= isset($errors['layout_name']) ? 'is-invalid' : '' ?>" value="<?= old('layout_name') ?>" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="layout_file" id="layout_file" class="form-control <?= isset($errors['layout_file']) ? 'is-invalid' : '' ?>" value="<?= old('layout_file') ?>" required>
