                ...
                <form action="<?= base_url('cms/products/store') ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= session('errors.meta_title') ? 'is-invalid' : '' ?>" id="meta_title" name="meta_title" value="<?= old('meta_title') ?>" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control <?= session('errors.meta_description') ? 'is-invalid' : '' ?>" id="meta_description" name="meta_description" rows="5"><?= old('meta_description') ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control <?= session('errors.meta_keywords') ? 'is-invalid' : '' ?>" id="meta_keywords" name="meta_keywords" rows="5"><?= old('meta_keywords') ?></textarea>
