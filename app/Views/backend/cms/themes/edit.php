    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('cms/themes/update/' . $theme['id']) ?>" method="post">
                        <?= csrf_field() ?>
                        <div class="form-group">
                            <label for="theme_name">Theme Name</label>
                            <input type="text" name="theme_name" id="theme_name" class="form-control <?= isset($errors['theme_name']) ? 'is-invalid' : '' ?>" value="<?= old('theme_name', $theme['theme_name']) ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="directory" id="directory" class="form-control <?= isset($errors['directory']) ? 'is-invalid' : '' ?>" value="<?= old('directory', $theme['directory']) ?>">
