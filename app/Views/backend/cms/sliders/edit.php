    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('cms/sliders/update/' . $slider['id']) ?>" method="post">
                        <?= csrf_field() ?>

                        <!-- Slider Name -->
                        <div class="form-group">
                            <label for="name">Slider Name</label>
                            <input type="text" name="name" id="name" class="form-control <?= isset($errors['name']) ? 'is-invalid' : '' ?>" value="<?= old('name', $slider['name']) ?>">
