    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <form action="<?= base_url('cms/faq/store') ?>" method="POST">
                    <?= csrf_field() ?>
                    <div class="card-body">
                        <!-- Question -->
                        <div class="form-group">
                            <label for="question">Question</label>
                            <input type="text" class="form-control <?= session('errors.question') ? 'is-invalid' : '' ?>" id="question" name="question" value="<?= old('question') ?>" placeholder="Enter FAQ question" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control <?= session('errors.answer') ? 'is-invalid' : '' ?>" id="answer" name="answer" rows="5" placeholder="Enter FAQ answer" required><?= old('answer') ?></textarea>
