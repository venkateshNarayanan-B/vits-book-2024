    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <form action="<?= base_url('cms/pages/update/' . $page['id']) ?>" method="POST">
                    <div class="card-body">
                        <!-- Title -->
                        <div class="form-group">
                            <label for="title">Title</label>
                            <input type="text" class="form-control <?= session('errors.title') ? 'is-invalid' : '' ?>" id="title" name="title" value="<?= old('title', $page['title']) ?>" placeholder="Enter page title">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control summernote <?= session('errors.content') ? 'is-invalid' : '' ?>" id="content" name="content"><?= old('content', $page['content']) ?></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= session('errors.meta_keywords') ? 'is-invalid' : '' ?>" id="meta_keywords" name="meta_keywords" value="<?= old('meta_keywords', $page['meta_keywords']) ?>" placeholder="Enter meta keywords">
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control <?= session('errors.meta_description') ? 'is-invalid' : '' ?>" id="meta_description" name="meta_description" rows="2"><?= old('meta_description', $page['meta_description']) ?></textarea>
                            <div class="invalid-feedback">
