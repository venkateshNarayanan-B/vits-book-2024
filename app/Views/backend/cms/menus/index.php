        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="<?= base_url('cms/menus/create') ?>" class="btn btn-primary btn-sm float-right">
...
<script>
    $(document).ready(function () {
        $('#menusTable').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?= base_url('cms/menus/get-data') ?>",
                "type": "POST",
            },
            "columns": [
                { "data": "menu_name" },
                ...
                { 
                    "data": "url",
                    "render": function(data) {
                        return data ? `<a href="${data}" target="_blank">${data}</a>` : '<em>No URL</em>';
                    }
                },
                { "data": "position" },
                { 
                ...
                { 
                    ...
                    "render": function(data) {
                        return `
                            <a href="<?= base_url('cms/menus/edit/') ?>${data}" class="btn btn-info btn-sm">
        ...
        $('#menusTable').on('click', '.delete-btn', function () {
            ...
            if (confirm('Are you sure you want to delete this menu?')) {
                $.ajax({
                    url: `<?= base_url('cms/menus/delete/') ?>${id}`,
                    type: 'GET',
