        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card card-info">
                    ...
                    <?= form_open('contra-vouchers/store', ['class' => 'form-horizontal']) ?>
                    <div class="card-body">
                        <!-- Date -->
                            ...
                            <div class="col-sm-9">
                                <select name="debit_ledger" class="form-control select2" required>
                                    ...
                                    <?php foreach ($ledgers as $ledger): ?>
                                        <option value="<?= esc($ledger['id']) ?>" <?= old('debit_ledger') == $ledger['id'] ? 'selected' : '' ?>>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="credit_ledger" class="form-control select2" required>
                                    ...
                                    <?php foreach ($ledgers as $ledger): ?>
                                        <option value="<?= esc($ledger['id']) ?>" <?= old('credit_ledger') == $ledger['id'] ? 'selected' : '' ?>>
                                            <?= esc($ledger['ledger_name']) ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                    ...
                    <div class="card-footer">
                        <?= form_submit('submit', 'Create Contra Voucher', ['class' => 'btn btn-info']) ?>
