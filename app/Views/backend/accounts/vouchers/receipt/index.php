        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        <a href="<?= site_url('receipt-vouchers/create') ?>" class="btn btn-info mb-3">Create New Receipt Voucher</a>

                        <table id="receiptVouchersTable" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Date</th>
