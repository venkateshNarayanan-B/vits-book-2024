        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card card-info">
                    ...
                    <?= form_open('receipt-vouchers/update/' . $voucher['id'], ['class' => 'form-horizontal']) ?>
                    <div class="card-body">
                        <!-- Date -->
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="number" name="entries[<?= $index ?>][debit]"
                                                        class="form-control" placeholder="Debit" step="0.01"
                                                        value="<?= esc($entry['debit']) ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                    <?php endforeach; ?>
                    ...
                    <div class="card-footer">
                        <?= form_submit('submit', 'Update Receipt Voucher', ['class' => 'btn btn-info']) ?>
