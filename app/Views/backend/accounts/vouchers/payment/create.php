        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card card-info">
                    ...
                    <?= form_open('payment-vouchers/store', ['class' => 'form-horizontal']) ?>
                    <div class="card-body">
                        <!-- Date -->
                                ...
                                <div id="voucher-entries">
                                    <div class="entry mb-3">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" name="entries[0][credit]" class="form-control" placeholder="Credit" step="0.01" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card-footer">
                        <?= form_submit('submit', 'Create Payment Voucher', ['class' => 'btn btn-info']) ?>
