          ...
          <div class="col-12">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    ...
                    <a href="<?= base_url('roles/create') ?>" class="btn btn-primary btn-sm ml-auto">
...
<script>
  $(function () {
    ...
    $('#example2').on('click', '.edit-btn', function() {
      ...
      window.location.href = "<?= site_url('roles/edit/') ?>" + id;
    });

    // Permission Button Action
    $('#example2').on('click', '.permission-btn', function() {
      var id = $(this).data('id');
      //alert('Edit button clicked for ID: ' + id);
      // Redirect to edit page or open edit modal
      window.location.href = "<?= site_url('permissions/assign/') ?>" + id;
    });
