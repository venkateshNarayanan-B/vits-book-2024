    ...
    <div class="container">
        ...
        <div class="row vs-carousel" data-slide-show="4" data-lg-slide-show="3" data-md-slide-show="2" data-autoplay="true" data-arrows="false" data-dots="true" data-center-mode="true">
            <div class="col-lg-3">
                <div class="product-style1">
                    <div class="product-img">
                        <img src="<?= base_url('themes/farmix/') ?>assets/img/product/product-1-1.png" alt="product img">
                    </div>
                    <div class="product-meta">30% Off</div>
                    <div class="product-about">
                        <p class="text">800 ML</p>
                        <h2 class="product-title"><a href="product.html">Coconut Oil Jar</a></h2>
                        <span class="price"> <del>$18.00</del>$14.00</span>
                        <div class="rating">
            ...
            <div class="col-lg-3">
                <div class="product-style1">
                    <div class="product-img">
                        <img src="<?= base_url('themes/farmix/') ?>assets/img/product/product-1-2.png" alt="product img">
                    </div>
                    <div class="product-meta">30% Off</div>
                    <div class="product-about">
                        <p class="text">800 ML</p>
                        <h2 class="product-title"><a href="product.html">PureFroots Jar</a></h2>
                        <span class="price"> <del>$18.00</del>$14.00</span>
                        <div class="rating">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
            ...
            <div class="col-lg-3">
                <div class="product-style1">
                    <div class="product-img">
                        <img src="<?= base_url('themes/farmix/') ?>assets/img/product/product-1-3.png" alt="product img">
                    </div>
                    <div class="product-meta">30% Off</div>
                    <div class="product-about">
                        <p class="text">600 ML</p>
                        <h2 class="product-title"><a href="product.html">Nature's Bounty</a></h2>
            ...
            <div class="col-lg-3">
                <div class="product-style1">
                    <div class="product-img">
                        <img src="<?= base_url('themes/farmix/') ?>assets/img/product/product-1-4.png" alt="product img">
                    </div>
                    <div class="product-meta">32% Off</div>
                    <div class="product-about">
                        <p class="text">900 ML</p>
                        <h2 class="product-title"><a href="product.html">Organic Harvest</a></h2>
            ...
            <div class="col-lg-3">
                <div class="product-style1">
                    <div class="product-img">
                        <img src="<?= base_url('themes/farmix/') ?>assets/img/product/product-1-5.png" alt="product img">
                    </div>
                    <div class="product-meta">40% Off</div>
                    <div class="product-about">
                        <p class="text">700 ML</p>
                        <h2 class="product-title"><a href="product.html">Fresh & Rooted</a></h2>
            ...
            <div class="col-lg-3">
                <div class="product-style1">
                    <div class="product-img">
                        <img src="<?= base_url('themes/farmix/') ?>assets/img/product/product-1-6.png" alt="product img">
                    </div>
                    <div class="product-meta">30% Off</div>
                    <div class="product-about">
                        <p class="text">800 ML</p>
                        <h2 class="product-title"><a href="product.html">Froots & Greens</a></h2>
                        <span class="price"> <del>$18.00</del>$14.00</span>
                        <div class="rating">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
